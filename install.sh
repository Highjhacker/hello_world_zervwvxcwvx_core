...
git clone "https://github.com/Highjhacker/hello_world_zervwvxcwvx_core" "$HOME/core-token" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/Highjhacker/hello_world_zervwvxcwvx_core'"
    exit 1
fi
...
rm -rf "$HOME/.config/@HelloWorldZervwvxcwvx"
